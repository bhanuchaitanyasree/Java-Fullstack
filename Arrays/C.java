...
if(found)
{
System.out.println("Array contains the value:"+t);
}
else
{
System.out.println("Array doesnot contain the value:"+t);
}
}
}*/
/*6.
...
/*15.
public class EvenOddEasyWithMethod 
{
public static void main(String[] args) 
{
...
/*18.
public class RemoveDuplicatesSuperEasy 
{
public static void main(String[] args) 
{
int[] arr = {1, 2, 2, 3, 4, 4, 5};
